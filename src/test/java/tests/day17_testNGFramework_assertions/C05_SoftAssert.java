...
//URL in amazon icerdigini dogrulayin diyorsa>>> softassert;
//URL in amazon icerdigini test edin denirse hardassert kullanilir
// ama bu bir genelleme degil
public class C05_SoftAssert {
    //HATA VERIYOR NOSUCHELEMENT HATASI>ASLINDA FAILED BEKLENEN BIR TEST
    // AMA HATA MESAJLARINI YAZDIRMASI BEKLENIRKEN YAZDIRMADI
    //bakilacak!!!!
      /*
     ...
     */
      ...
      public void softAssertionTesti() {
        ...
        // ilk urune tiklayalim
          ...
          String actualIsim =amazonPage.ilkUrunElementi.getText();
